...
Geplante Features: Funktion aktuelle Rezepte zu speichern und gespeicherte Rezepte wieder zu laden, Möglichkeit einzustellen, dass es keine Zwischenprofukte geben soll

Das neu erzeugte Graphelement kann plaziert werden und durch die kleinen Knöpfe über/unter den In-/Outputs verbunden werden. Es ist jeweils nur möglich von einem In-/Output zu einem anderen zu verbinden, zum Aufteilen/Zusammenführen gibt es den "Splitter". Um eine Node zu verschieben muss auf sie rechtsgecklickt werden. Man kann sie löschen, indem man sie auf den rechten Rand verschiebt.
Geplante Features: späteres Ändern der In-/Outputanzahl, schönere Verbindungen bei Verbindungen nach oben, Prioretisierung bei Splittern, mehr/andere Splittermodi (falls erforderlich)
...
Geplante Features: Unterstützung aller Aspectratios und Pixeldichten
...
Geplante Features: Splitter implememntieren
