...
Geplante Features: Verschieben, Löschen, späteres Ändern der In-/Outputanzahl, besere Ansicht zum verbinden (Erste ausgewählte Node highlighten), mehr/andere Splittermodi (falls erforderlich)
